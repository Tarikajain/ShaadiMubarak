          ...
          <AnimatePresence mode="wait">
            ...
            {mainTab === 'list' && (
              <motion.div key="list" initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 8 }} transition={{ duration: 0.22 }}
                ...
                {/* Search bar */}
                <div className="glass-input flex items-center gap-2" style={{ padding: '10px 14px' }}>
                  <Search size={14} color="rgba(26,20,16,0.28)" style={{ flexShrink: 0 }} />
                  <input
                    value={search}
                ...
                {/* Filter row: RSVP dropdown + Side dropdown + Upload button */}
                <div className="flex items-center gap-2">
